import { HistoriesType, VoyageType } from './리팩토링전2';

class Rating {
  voyage;
  history;

  constructor(voyage: VoyageType, history: HistoriesType) {
    this.voyage = voyage;
...
function craeteRating(voyage: VoyageType, history: HistoriesType) {
...
const rating = (voyage: VoyageType, history: HistoriesType) => {
  return craeteRating(voyage, history);
};
